...
{
    if (!strcmp(username, "imManager") && !strcmp(passwords, "admin12"))
    {
        return 1;
    }
    else
...
switch (department()){
    ...
    case 1:
        ...
        {
            system("cls");
            printf("\t\t\t\t\t\t\t   **********************************************\n\t\t\t\t\t\t\t*WELCOME TO LAPTOPS DEPARTMENT'S DATABASE*\n\t\t\t\t\t\t\t   **********************************************\n\n");
            printf("1. Add new laptop item to database\n");
